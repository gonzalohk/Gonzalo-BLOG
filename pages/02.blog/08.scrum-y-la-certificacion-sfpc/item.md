...
Scrum es un marco de trabajo para desarrollar, entregar y mantener productos complejos. En tal sentido, se ha usado para desarrollar software, hardware, en variedad de entornos como empresas, escuelas, gobiernos e incluso para gestionar la operación de organizaciones en diversidad de áreas.
...
Puede ser evaluada con diferentes centros certificadores, uno de ellos es [https://certiprof.com/pages/sfpc](CertiProf) . El examen es accesible incluso para persona que recién inician a adoptar metodologías  ágiles,  no representa complicación al resolverlo, es muy recomendable hacerlo.